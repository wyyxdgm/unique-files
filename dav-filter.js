...
const { name, csvFilePath, filteredFilePath, separator, KEYS, title, regexp, processRowString, processRow } = require('./dav-var')
...
rl.on('line', (line) => {
  ...
  const processedRow = processRowString(line);
